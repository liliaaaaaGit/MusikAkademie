/*
  # Fix Admin and Teacher Notifications for Trial Lessons

  1. Changes
    - Ensure teachers receive notifications for new open trial lessons
    - Prevent admins from receiving notifications about trial lessons they created
    - Ensure proper notification routing based on user roles
    - Fix notification visibility issues

  2. Function Updates
    - Update notify_new_open_trial to properly notify teachers about new open trials
    - Ensure trial notifications are properly filtered by role
    - Fix notification message content for better clarity

  3. RLS Policy Updates
    - Update policies to ensure proper notification visibility
    - Ensure teachers can see notifications about new open trials
*/
...
BEGIN
  ...
  -- Skip notification creation if the creator is an admin
