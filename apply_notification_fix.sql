...
-- =====================================================
-- This fixes the issue where teachers cannot see notifications
-- in the Postfach when contracts are fulfilled
...
-- Check current notifications (should show teacher_id as null)
SELECT 
  id,
  type,
  contract_id,
...
-- Create the fixed notification function
...
BEGIN
  ...
  -- Check for status change from 'active' to 'completed'
  ...
  IF should_notify THEN
    ...
    SELECT 
      ...
      s.id,
      t.name,
      t.profile_id  -- This is the key fix - get profile_id
    INTO 
      student_name,
      student_id_val,
      teacher_name,
    ...
    -- This is the critical fix - use teacher_profile_id
