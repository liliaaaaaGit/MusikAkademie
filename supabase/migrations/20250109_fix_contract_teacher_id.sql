-- Fix atomic_save_and_sync_contract function to include teacher_id field
-- This fixes the "null value in column teacher_id violates not-null constraint" error
