-- Fix atomic_save_and_sync_contract function to handle discount_ids scalar values
BEGIN;
...
BEGIN
    ...
    -- Update contract_operation_log status
...
EXCEPTION
    WHEN OTHERS THEN
        -- Log the error in contract_operation_log
        UPDATE public.contract_operation_log
