-- Comprehensive Lesson Tracking Fix
-- Run this in your Supabase SQL Editor to fix all lesson tracking issues

BEGIN;

-- =====================================================
-- 1. FIX BATCH UPDATE LESSONS FUNCTION
-- =====================================================

-- Drop and recreate the function with proper array handling AND contract completion
...
-- =====================================================
-- 4. ENSURE RLS POLICIES FOR NOTIFICATIONS
-- =====================================================
...
CREATE POLICY notifications_insert_policy
  ...
  WITH CHECK (
    ...
    public.get_user_role() IN ('admin', 'admin')
  );
